...
async def test_create_book(db_session, async_client):
    seller = sellers.Seller(first_name="Ivan", last_name="Ivanov", email="iivanov@mail.ru", password="vano228")

    db_session.add(seller)
    await db_session.flush()

    data = {"title": "Hobbit", "author": "John Tolkien", "pages": 337, "year": 2013, "seller_id": seller.id}
...
async def test_get_books(db_session, async_client):
    ...
    seller = sellers.Seller(first_name="Andrew", last_name="Robbinson", email="andrew@gmail.com", password="RobbinsonCruso228")
